    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btngenOTP.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                ...
                {
                    Toast.makeText(phoneotp.this, "Enter Valid Phone No.", Toast.LENGTH_SHORT).show();
                }
                else {
        ...
        btnverify.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                ...
                {
                    Toast.makeText(phoneotp.this, "Wrong OTP Entered", Toast.LENGTH_SHORT).show();
                }
                else
        ...
        firebaseAuth.signInWithCredential(credential)
                .addOnCompleteListener(new OnCompleteListener() {
                    ...
                    public void onComplete(@NonNull Task task)
                    {
                        ...
                        {
                            Toast.makeText(phoneotp.this, "Login Successfull", Toast.LENGTH_SHORT).show();
